...
public class UsersControllerTests : IDisposable
{
    ...
    /// <summary>
    /// Test: GET /api/Users/metadata returns all roles and departments
    /// Expected: 200 OK with UserMetadataDTO containing Roles and Departments lists
    /// </summary>
    [Fact]
    public async Task GetMetadata_ReturnsRolesAndDepartments()
    {
        // Arrange
        ...
        var dept1 = new Department { DepartmentId = 1, Name = "IT Department", CreateDate = DateTime.Now };
        var dept2 = new Department { DepartmentId = 2, Name = "HR Department", CreateDate = DateTime.Now };
        ...
        var metadata = Assert.IsType<UserMetadataDTO>(okResult.Value);
        Assert.Equal(3, metadata.Roles.Count);
        Assert.Equal(2, metadata.Departments.Count);

        Assert.Contains(metadata.Roles, r => r.Name == "Admin");
        Assert.Contains(metadata.Roles, r => r.Name == "Manager");
        Assert.Contains(metadata.Roles, r => r.Name == "Staff");

        Assert.Contains(metadata.Departments, d => d.Name == "IT Department");
        Assert.Contains(metadata.Departments, d => d.Name == "HR Department");
    }

    /// <summary>
    /// Test: GET /api/Users/metadata with no roles/departments returns empty lists
    /// Expected: 200 OK with UserMetadataDTO containing empty Roles and Departments
    /// </summary>
    [Fact]
    public async Task GetMetadata_WithNoData_ReturnsEmptyLists()
    {
        // Act
        var result = await _controller.GetMetadata();
        ...
        Assert.Empty(metadata.Departments);
    }
    ...
    /// <summary>
    /// Test: GET /api/Users/roles returns all roles
    /// Expected: 200 OK with IEnumerable&lt;RoleOptionDTO&gt;
    /// </summary>
    [Fact]
    public async Task GetRoles_ReturnsAllRoles()
    {
        ...
        _context.Roles.AddRange(
            new Role { RoleId = 1, Name = "Admin", Code = "ADMIN", CreateDate = DateTime.Now },
            new Role { RoleId = 2, Name = "Manager", Code = "MGR", CreateDate = DateTime.Now },
            new Role { RoleId = 3, Name = "Staff", Code = "STAFF", CreateDate = DateTime.Now }
        );
        await _context.SaveChangesAsync();
        ...
        // Assert
        var okResult = Assert.IsType<OkObjectResult>(result.Result);
        var roles = Assert.IsAssignableFrom<IEnumerable<RoleOptionDTO>>(okResult.Value);
        var roleList = roles.ToList();

        Assert.Equal(3, roleList.Count);
        Assert.Contains(roleList, r => r.RoleId == 1 && r.Name == "Admin");
        Assert.Contains(roleList, r => r.RoleId == 2 && r.Name == "Manager");
        Assert.Contains(roleList, r => r.RoleId == 3 && r.Name == "Staff");
    }

    /// <summary>
    /// Test: GET /api/Users/roles returns empty list when no roles exist
    /// Expected: 200 OK with empty IEnumerable&lt;RoleOptionDTO&gt;
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test: GET /api/Users/departments returns all departments
    /// Expected: 200 OK with IEnumerable&lt;DepartmentOptionDTO&gt;
    /// </summary>
    [Fact]
    public async Task GetDepartments_ReturnsAllDepartments()
    {
        ...
        _context.Departments.AddRange(
            new Department { DepartmentId = 1, Name = "IT Department", CreateDate = DateTime.Now },
            new Department { DepartmentId = 2, Name = "HR Department", CreateDate = DateTime.Now },
            new Department { DepartmentId = 3, Name = "Finance Department", CreateDate = DateTime.Now }
        );
        await _context.SaveChangesAsync();
        ...
        // Assert
        var okResult = Assert.IsType<OkObjectResult>(result.Result);
        var departments = Assert.IsAssignableFrom<IEnumerable<DepartmentOptionDTO>>(okResult.Value);
        var deptList = departments.ToList();

        Assert.Equal(3, deptList.Count);
        Assert.Contains(deptList, d => d.DepartmentId == 1 && d.Name == "IT Department");
        Assert.Contains(deptList, d => d.DepartmentId == 2 && d.Name == "HR Department");
        Assert.Contains(deptList, d => d.DepartmentId == 3 && d.Name == "Finance Department");
    }

    /// <summary>
    /// Test: GET /api/Users/departments returns empty list when no departments exist
    /// Expected: 200 OK with empty IEnumerable&lt;DepartmentOptionDTO&gt;
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test: POST /api/Users/{id}/roles with empty role list removes all roles
    /// Expected: 200 OK with no roles assigned
    /// </summary>
    [Fact]
    public async Task ManageUserRoles_WithEmptyRoles_RemovesAllRoles()
    {
        // Arrange
        var user = new User
        {
        ...
        var dto = new AssignRoleDTO { RoleIds = new List<int>() };
    ...
    #region AdminChangePassword Tests

    /// <summary>
    /// Test: PUT /api/Users/{id}/password with valid data changes password
    /// Expected: 204 No Content and Password is updated in database
    /// </summary>
    [Fact]
    public async Task AdminChangePassword_WithValidData_ReturnsNoContent()
    {
        ...
        // Act
        var result = await _controller.AdminChangePassword(1, dto);
    ...
    /// <summary>
    /// Test: PUT /api/Users/{id}/password with invalid user ID returns 404
    /// Expected: 404 Not Found
    /// </summary>
    [Fact]
    public async Task AdminChangePassword_WithInvalidId_ReturnsNotFound()
    {
        // Arrange
        var dto = new AdminChangePasswordDTO
        {
        ...
        // Act
        var result = await _controller.AdminChangePassword(999, dto);
    ...
    /// <summary>
    /// Test: PUT /api/Users/{id}/password with mismatched passwords returns 400
    /// Expected: 400 Bad Request
    /// </summary>
    [Fact]
    public async Task AdminChangePassword_WithMismatchedPasswords_ReturnsBadRequest()
    {
        // Arrange
        var user = new User
        {
    ...
    /// <summary>
    /// Test: PUT /api/Users/{id}/password with password shorter than 6 characters returns 400
    /// Expected: 400 Bad Request
    /// </summary>
    [Fact]
    public async Task AdminChangePassword_WithShortPassword_ReturnsBadRequest()
    {
        // Arrange
        var user = new User
        {
